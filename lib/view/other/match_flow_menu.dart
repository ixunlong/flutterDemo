...
class MatchFlowButton extends StatefulWidget {
  //按钮图标
  ...
  @override
  _MatchFlowButtonState createState() => _MatchFlowButtonState();
}

//旋转变换按钮 向上弹出的效果 State实现
class _MatchFlowButtonState extends State<MatchFlowButton>
  ...
  Widget floatButton() {
    return Container(
      width: widget.fabHeight,
      height: widget.fabHeight,
      child: GestureDetector(onTap: floatClick, child: widget.mainIcon),
    );
  }
