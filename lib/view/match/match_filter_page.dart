...
class MatchFilterPage extends StatefulWidget {
  const MatchFilterPage({super.key});
...
class _MatchFilterPageState extends State<MatchFilterPage>
  ...
  late SoccerMatchFilterController leagueController;
  ...
  void initState() {
    ...
    if (tabIndex == 0) {
      leagueController = Get.find<SoccerMatchFilterController>(
  ...
  void tapTabbar(index) {
    ...
    if (index == 1) {
      ...
      leagueType = LeagueType.dc;
    } else if (index == 3) {
      leagueType = LeagueType.ssc;
    }
  ...
  Widget bottomBar() {
    ...
    return GetBuilder<SoccerMatchFilterController>(
        tag: tag,
        builder: (controller) {
          return Container(
            // height: 50,
            ...
            child: Row(children: [
              CommonButton(
                onPressed: () {
                  Utils.onEvent('sxy_sxan', params: {'sxy_sxan': '1'});
              ...
              CommonButton(
                  onPressed: () {
                    Utils.onEvent('sxy_sxan', params: {'sxy_sxan': '2'});
              ...
              CommonButton(
                  onPressed: () {
                    Utils.onEvent('sxy_sxan', params: {'sxy_sxan': '3'});
...
class _MatchFilterViewState extends State<MatchFilterView> {
  ...
  void initState() {
    ...
    leagueController =
        Get.find<SoccerMatchFilterController>(tag: controllerTag);
  }
