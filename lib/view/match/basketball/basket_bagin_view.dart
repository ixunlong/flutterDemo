...
class BasketBeginView extends StatefulWidget {
  const BasketBeginView({super.key});

  @override
  State<BasketBeginView> createState() => _BasketBeginViewState();
}

class _BasketBeginViewState extends State<BasketBeginView> {
  final controller = Get.put(BasketListBeginController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BasketListBeginController>(builder: (_) {
      return Stack(
        children: [
          EasyRefresh(
