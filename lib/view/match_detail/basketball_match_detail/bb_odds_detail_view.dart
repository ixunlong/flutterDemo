...
import 'package:sports/logic/basketball/bb_odds_detail_controller.dart';
...
class BbOddsDetailView extends StatelessWidget {
  BbOddsDetailView({Key? key}) : super(key: key);

  final controller = Get.put(BbOddsDetailController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<BbOddsDetailController>(
      builder: (controller) {
        return Scaffold(
          ...
          appBar: Styles.appBar(
            ...
            title: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  Expanded(child: Text(controller.detail.detail?.awayTeamName ?? "",
                    overflow: TextOverflow.ellipsis).alignEnd),
                  const Text(" vs "),
                  Expanded(child: Text(controller.detail.detail?.homeTeamName ?? "",
      ...
      children: [
        ...
        Row(
          children: [
            ...
            if(i==0) Expanded(flex: 2, child: Container()),
            Expanded(flex: 2,child: Text(controller.headTypeList[i][1],style: Styles.normalSubText(fontSize: 12)).center),
            if(i!=0) Expanded(flex: 2,child: Text(controller.headTypeList[i][2],style: Styles.normalSubText(fontSize: 12)).center),
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        (i == 1 || i == 2 ?
                        Text(entity.closed == "封"?"封":entity.line ?? "",
