...
class VerificationCode extends StatefulWidget {
  ...
  @override
  cVerificationCodeState createState() => cVerificationCodeState();
}

class cVerificationCodeState extends State<VerificationCode> {
  //随机生成绘图数据
  Map getRandomData() {
    // 数字list
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: CustomPaint(
          painter: VerificationCodePainter(drawData: drawData),
        ));
  }
...
class VerificationCodePainter extends CustomPainter {
  final Map drawData;
  VerificationCodePainter({
