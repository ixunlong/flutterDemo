...
class MaxBottomSheet extends StatefulWidget {
  /// Creates a bottom sheet.
  ///
  /// Typically, bottom sheets are created implicitly by
  /// [ScaffoldState.showBottomSheet], for persistent bottom sheets, or by
  /// [showModalBottomSheet], for modal bottom sheets.
  const MaxBottomSheet({
    super.key,
  ...
  @override
  State<MaxBottomSheet> createState() => _MaxBottomSheetState();
...
class _MaxBottomSheetState extends State<MaxBottomSheet> {
